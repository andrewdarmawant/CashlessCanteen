...
<div class="row">
<div id="vendor_info">
<table cellpadding-left = 100px>
 <tr>
    <td><a href="selecttransactionhistory.php" class="btn btn-primary px-3 py-3">Transaction History</a> </td> 
  </tr>
  <tr>
    <td><a href="selecttotalrevenues.php" class="btn btn-primary px-3 py-3">Total Revenues</a></td> 
  </tr>
  <tr>
    <td><a href="itemssold.php" class="btn btn-primary px-3 py-3">Items Sold</a> </td> </td> 

  </tr>
  <tr>
    <td><a href="transactionsperday.php" class="btn btn-primary px-3 py-3">Transactions Per Day</a> </td> </td> 
  </tr>
</table>
