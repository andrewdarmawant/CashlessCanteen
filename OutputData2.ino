...
bool outs2;
bool outs3;
long price;   // might not be needed
long balance; // might not be needed
...
/* 
  ...
  //example of getting from serial monitor
*/
//balance= 500000;
//price=0;
...
void UID(){
  ...
  {
//     Serial.print(mfrc522.uid.uidByte[i] < 0x10 ? " 0" : " "); // find better solution so only print one time
